...
function SideBar({ logOut }) {
    return (
        <div>
            <div className="p-4 mt-12 overflow-y-auto w-[19rem] inline-block">

                <div className="py-4 overflow-y-auto">
                    <ul className="space-y-2">
                        <li>
                            <Link href={'/user/profile'} className="flex items-center p-2 text-base font-normal text-gray-900  rounded-lg dark:text-white hover:bg-gray-100  dark:hover:bg-gray-700">
                        ...
                        <li>
                            <Link href={"/user/settings"} className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
